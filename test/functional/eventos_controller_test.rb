...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { data_prevista: @evento.data_prevista, data_realizada: @evento.data_realizada, status: @evento.status }
    end
  ...
  test "should update evento" do
    put :update, id: @evento, evento: { data_prevista: @evento.data_prevista, data_realizada: @evento.data_realizada, status: @evento.status }
    assert_redirected_to evento_path(assigns(:evento))
  end
